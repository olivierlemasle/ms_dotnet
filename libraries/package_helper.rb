    ...
    def packages
      @packages ||= ::Mash.new(
        ...
        'KB3083184' => {
          ...
          not_if:   'C:\\Windows\\System32\\wbem\\wmic.exe QFE where HotFixID="KB3083184" | FindStr "KB3083184"',
        },
        'KB3083185' => {
          ...
          not_if:   'C:\\Windows\\System32\\wbem\\wmic.exe QFE where HotFixID="KB3083185" | FindStr "KB3083185"',
        },
        'KB3083186' => {
